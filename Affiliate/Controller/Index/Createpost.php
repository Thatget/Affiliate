    ...
    public function execute()
    {
        ...
        if($getway_withdrawn == 'banktransfer')
        {
            ...
            else if(sizeof($customers) == 0)
            {
                ...
                if($cokie != 0) {
                    $this->_dataHelper->updateAffiliateInvitionNew($customer_id,
                        $cokie, $clientIP,$referral_from,$referral_from_domain,$referral_to,$invitation_type);
                }
            }
            ...
            else if($active == \MW\Affiliate\Model\Statusactive::ACTIVE)
            {
