...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        try {
            $gateways = unserialize($this->getStoreConfig('affiliate/money/gateways', $storeCode));
        }catch(\Exception $e){
    ...
    public function sendMailCustomerActiveAffiliate($customerId)
    {
        ...
        $emailData = [
            ...
            'sender_name' => $senderName,
            'store_name' => $storeName,
            'customer_affiliate_link' => $store->getUrl('affiliate')
        ];
    ...
    public function sendEmailAdminActiveAffiliate($customerId)
    {
        ...
        } else if (substr_count($adminEmails,',') > 0) {
