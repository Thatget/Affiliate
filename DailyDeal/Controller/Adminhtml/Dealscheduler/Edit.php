...
class Edit extends \MW\DailyDeal\Controller\Adminhtml\Dealscheduler
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            $this->_coreRegistry->register('deal_product_ids', $products);
            $this->_coreRegistry->register('current_deal_scheduler', $model);
        }
        ...
        $resultPage->getConfig()->getTitle()->prepend(
            $model->getId() ?
                __('Edit Deal Scheduler %1', $this->_escaper->escapeHtml($model->getTitle())) : __('New Deal Scheduler')
        );
