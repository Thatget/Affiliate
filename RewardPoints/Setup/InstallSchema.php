...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_point_order'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_point_history'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_point_customer'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_product_point'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_catalog_rules'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_cart_rules'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_active_rules'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_spend_cart_rules'));
        ...
        $setup->getConnection()->dropTable($setup->getTable('mw_reward_point_sell_point'));
