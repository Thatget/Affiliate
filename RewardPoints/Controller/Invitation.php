...
abstract class Invitation extends \Magento\Framework\App\Action\Action
{
    ...
    protected function _sendEmailTransaction($emailTo, $name, $template, $data)
    {
        ...
        $senderName = $this->_dataHelper->getStoreConfig('trans_email/ident_'.$sender.'/name', $store->getCode());
        $senderEmail = $this->_dataHelper->getStoreConfig('trans_email/ident_'.$sender.'/email', $store->getCode());
